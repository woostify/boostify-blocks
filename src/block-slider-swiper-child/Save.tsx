...
import { WCB_SLIDER_PANEL_STYLE_DIMENSION_DEMO } from "../block-slider-swiper/WcbSliderPanel_StyleDimension";
...
export default function save({ attributes, context }: { attributes: WcbAttrs, context?: any }) {
	...
	// Clean structure for swiper + frontend CSS system with correct timing.
	// The root element must carry the "swiper-slide" class: Swiper requires
	// every direct child of .swiper-wrapper to have it.
	return (
		<div
