...
export interface WCB_TEAM_PANEL_STYLE_DIMENSION
	extends MyDimensionsNoGapControlData {}

export const WCB_TEAM_PANEL_STYLE_DIMENSION_DEMO: WCB_TEAM_PANEL_STYLE_DIMENSION =
	{
		...MY_DIMENSIONS_NO_GAP_CONTROL_DEMO,
		padding: {
			Desktop: {
...
interface Props
	...
	panelData: WCB_TEAM_PANEL_STYLE_DIMENSION;
	setAttr__: (data: WCB_TEAM_PANEL_STYLE_DIMENSION) => void;
}

const WcbTeamPanel_StyleDimension: FC<Props> = ({
...
export default WcbTeamPanel_StyleDimension;
