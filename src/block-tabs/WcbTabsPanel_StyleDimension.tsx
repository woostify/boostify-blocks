...
export interface WCB_TABS_PANEL_STYLE_DIMENSION
	extends MyDimensionsNoGapControlData {}

export const WCB_TABS_PANEL_STYLE_DIMENSION_DEMO: WCB_TABS_PANEL_STYLE_DIMENSION =
	{
		...MY_DIMENSIONS_NO_GAP_CONTROL_DEMO,
		padding: {
			Desktop: {
...
interface Props
	...
	panelData: WCB_TABS_PANEL_STYLE_DIMENSION;
	setAttr__: (data: WCB_TABS_PANEL_STYLE_DIMENSION) => void;
}

const WcbTabsPanel_StyleDimension: FC<Props> = ({
...
export default WcbTabsPanel_StyleDimension;
