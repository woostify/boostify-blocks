...
export interface WCB_FAQ_PANEL_STYLE_DIMENSION
	extends MyDimensionsNoGapControlData {}

export const WCB_FAQ_PANEL_STYLE_DIMENSION_DEMO: WCB_FAQ_PANEL_STYLE_DIMENSION =
	{
		...MY_DIMENSIONS_NO_GAP_CONTROL_DEMO,
		padding: {
			Desktop: {
...
interface Props
	...
	panelData: WCB_FAQ_PANEL_STYLE_DIMENSION;
	setAttr__: (data: WCB_FAQ_PANEL_STYLE_DIMENSION) => void;
}

const WcbFaqPanel_StyleDimension: FC<Props> = ({
...
export default WcbFaqPanel_StyleDimension;
