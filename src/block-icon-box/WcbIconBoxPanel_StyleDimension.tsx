...
export interface BCB_ICON_BOX_PANEL_STYLE_DIMENSION
	extends MyDimensionsNoGapControlData {}

export const BCB_ICON_BOX_PANEL_STYLE_DIMENSION_DEMO: BCB_ICON_BOX_PANEL_STYLE_DIMENSION =
	{
		...MY_DIMENSIONS_NO_GAP_CONTROL_DEMO,
		padding: {
			Desktop: {
...
interface Props
	...
	panelData: BCB_ICON_BOX_PANEL_STYLE_DIMENSION;
	setAttr__: (data: BCB_ICON_BOX_PANEL_STYLE_DIMENSION) => void;
}

const WcbIconBoxPanel_StyleDimension: FC<Props> = ({
	panelData = BCB_ICON_BOX_PANEL_STYLE_DIMENSION_DEMO,
	setAttr__,
	initialOpen,
	onToggle,
	opened,
