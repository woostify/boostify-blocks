...
export interface BCB_ICON_BOX_PANEL_STYLE_SEPARATOR {
	border: BorderMainSingleSide;
	width: HasResponsive<string>;
	marginBottom: HasResponsive<string>;
}

export const BCB_ICON_BOX_PANEL_STYLE_SEPARATOR_DEMO: BCB_ICON_BOX_PANEL_STYLE_SEPARATOR =
	{
		border: {
			...DEFAULT_BORDER_MAIN_SINGLE_SIDE,
			color: "#334155",
...
interface Props
	...
	panelData: BCB_ICON_BOX_PANEL_STYLE_SEPARATOR;
	setAttr__: (data: BCB_ICON_BOX_PANEL_STYLE_SEPARATOR) => void;
}

const WcbIconBoxPanel_StyleSeparator: FC<Props> = ({
	panelData = BCB_ICON_BOX_PANEL_STYLE_SEPARATOR_DEMO,
	setAttr__,
	initialOpen,
	onToggle,
	opened,
