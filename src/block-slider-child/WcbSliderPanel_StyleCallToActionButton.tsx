...
export interface BCB_SLIDER_PANEL_STYLE_CALL_TO_ACTION_BUTTON extends MyDimensionsNoGapControlData, MyBorderControlData {
...
export const BCB_SLIDER_PANEL_STYLE_CALL_TO_ACTION_BUTTON_DEMO: BCB_SLIDER_PANEL_STYLE_CALL_TO_ACTION_BUTTON =
	{
		typographyText: {
			...TYPOGRAPHY_CONTROL_DEMO,
		},
...
export const BCB_SLIDER_PANEL_STYLE_CALL_TO_ACTION_BUTTON_PRESET_2: BCB_SLIDER_PANEL_STYLE_CALL_TO_ACTION_BUTTON =
	{
		typographyText: {
			...TYPOGRAPHY_CONTROL_DEMO,
		},
...
export const BCB_SLIDER_PANEL_STYLE_CALL_TO_ACTION_BUTTON_PRESET_3: BCB_SLIDER_PANEL_STYLE_CALL_TO_ACTION_BUTTON =
	{
		typographyText: {
			...TYPOGRAPHY_CONTROL_DEMO,
		},
...
export const BCB_SLIDER_PANEL_STYLE_CALL_TO_ACTION_BUTTON_PRESET_4: BCB_SLIDER_PANEL_STYLE_CALL_TO_ACTION_BUTTON =
	{
		typographyText: {
			...TYPOGRAPHY_CONTROL_DEMO,
		},
...
export const BCB_SLIDER_PANEL_STYLE_CALL_TO_ACTION_BUTTON_PRESET_5: BCB_SLIDER_PANEL_STYLE_CALL_TO_ACTION_BUTTON =
	{
		typographyText: {
			...TYPOGRAPHY_CONTROL_DEMO,
		},
...
export const BCB_SLIDER_PANEL_STYLE_CALL_TO_ACTION_BUTTON_PRESET_6: BCB_SLIDER_PANEL_STYLE_CALL_TO_ACTION_BUTTON =
	{
		typographyText: {
			...TYPOGRAPHY_CONTROL_DEMO,
		},
...
export const BCB_SLIDER_PANEL_STYLE_CALL_TO_ACTION_BUTTON_PRESET_7: BCB_SLIDER_PANEL_STYLE_CALL_TO_ACTION_BUTTON =
	{
		typographyText: {
			...TYPOGRAPHY_CONTROL_DEMO,
		},
...
export const BCB_SLIDER_PANEL_STYLE_CALL_TO_ACTION_BUTTON_PRESET_8: BCB_SLIDER_PANEL_STYLE_CALL_TO_ACTION_BUTTON =
	{
		typographyText: {
			...TYPOGRAPHY_CONTROL_DEMO,
		},
...
interface Props
	...
	panelData: BCB_SLIDER_PANEL_STYLE_CALL_TO_ACTION_BUTTON;
	setAttr__: (data: BCB_SLIDER_PANEL_STYLE_CALL_TO_ACTION_BUTTON) => void;
}

const WcbSliderPanelCallToActionButton: FC<Props> = ({
	panelData = BCB_SLIDER_PANEL_STYLE_CALL_TO_ACTION_BUTTON_DEMO,
	setAttr__,
	initialOpen,
	onToggle,
	opened,
