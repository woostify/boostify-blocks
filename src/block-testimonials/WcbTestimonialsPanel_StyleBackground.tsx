...
export interface BCB_TESTIMONIALS_PANEL_STYLE_BACKGROUND_BORDER {
	background: BackgroundControlData;
	border: MyBorderControlData;
}
export const BCB_TESTIMONIALS_PANEL_STYLE_BACKGROUND_BORDER_DEMO: BCB_TESTIMONIALS_PANEL_STYLE_BACKGROUND_BORDER =
	{
...
interface Props
	...
	panelData: BCB_TESTIMONIALS_PANEL_STYLE_BACKGROUND_BORDER;
	setAttr__: (data: BCB_TESTIMONIALS_PANEL_STYLE_BACKGROUND_BORDER) => void;
}

const WcbTestimonialsPanel_StyleBackground: FC<Props> = ({
	panelData = BCB_TESTIMONIALS_PANEL_STYLE_BACKGROUND_BORDER_DEMO,
	setAttr__,
	initialOpen,
	onToggle,
	opened,
