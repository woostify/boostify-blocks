	...
	const onSelectMedia = (media: any) => {
		const srcSet = [
			media.url && media.width
				...
				: null,
			media.sizes?.thumbnail?.url && media.sizes?.thumbnail?.width
				? `${media.sizes.thumbnail.url} ${media.sizes.thumbnail.width}w`
				: null,
			media.sizes?.medium?.url && media.sizes?.medium?.width
				? `${media.sizes.medium.url} ${media.sizes.medium.width}w`
				: null,
			media.sizes?.large?.url && media.sizes?.large?.width
				? `${media.sizes.large.url} ${media.sizes.large.width}w`
				: null,
			media.sizes?.full?.url && media.sizes?.full?.width
				? `${media.sizes.full.url} ${media.sizes.full.width}w`
				: null,
		].filter(Boolean).join(", ");
