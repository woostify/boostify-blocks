...
export interface WCB_IMAGE_PANEL_STYLE_DIMENSION
	extends MyDimensionsNoGapControlData {}

export const WCB_IMAGE_PANEL_STYLE_DIMENSION_DEMO: WCB_IMAGE_PANEL_STYLE_DIMENSION =
	{
		...MY_DIMENSIONS_NO_GAP_CONTROL_DEMO,
		padding: {
			Desktop: {
...
interface Props
	...
	panelData: WCB_IMAGE_PANEL_STYLE_DIMENSION;
	setAttr__: (data: WCB_IMAGE_PANEL_STYLE_DIMENSION) => void;
}

const WcbImagePanel_StyleDimension: FC<Props> = ({
...
export default WcbImagePanel_StyleDimension;
