...
export interface WCB_PRODUCTS_PANEL_STYLE_DIMENSION
	extends MyDimensionsNoGapControlData {}

export const WCB_PRODUCTS_PANEL_STYLE_DIMENSION_DEMO: WCB_PRODUCTS_PANEL_STYLE_DIMENSION =
	{
		...MY_DIMENSIONS_NO_GAP_CONTROL_DEMO,
		padding: {
			Desktop: {
...
interface Props
	...
	panelData: WCB_PRODUCTS_PANEL_STYLE_DIMENSION;
	setAttr__: (data: WCB_PRODUCTS_PANEL_STYLE_DIMENSION) => void;
}

const WcbProductsPanel_StyleDimension: FC<Props> = ({
...
export default WcbProductsPanel_StyleDimension;
