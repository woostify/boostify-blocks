...
const GlobalCss: FC<Props> = (attrs) => {
	...
	const BOX_CLASSNAME = `${WRAP_CLASSNAME} .bcb-form__box`;
	const INNER_CLASSNAME = `${WRAP_CLASSNAME} .bcb-form__inner`;
	...
	const CHECKBOX_RADIO_CLASSNAME = `${WRAP_CLASSNAME} .bcb-radio__option, ${WRAP_CLASSNAME} .bcb-checkbox__option`;
	const CHECKBOX_RADIO_INPUT_CLASSNAME = `${WRAP_CLASSNAME} input[type="checkbox"], ${WRAP_CLASSNAME} input[type="radio"]`;
	const TOGGLE_CLASSNAME = `${WRAP_CLASSNAME} .bcb-toggle__switch`;
	const SUBMIT_CLASSNAME = `${WRAP_CLASSNAME} .bcb-form__btn-submit`;
	const SUCCESS_MESS_CLASSNAME = `${WRAP_CLASSNAME} .bcb-form__successMessageText`;
	const ERROR_MESS_CLASSNAME = `${WRAP_CLASSNAME} .bcb-form__errorMessageText`;
	...
	const renderToggleSize = () => {
		...
		return (
			<Global
				styles={{
					[`${TOGGLE_CLASSNAME}`]: {
						".bcb-toggle__slider::before": {
							width: mobileSize,
							height: mobileSize,
						},
						"input:checked + .bcb-toggle__slider:before": {
	...
	const renderLabelMarginBottom = () => {
		...
		return (
			<Global
				styles={{
					[`${WRAP_CLASSNAME} .bcb-form__label`]: {
		...
		<>
			...
			<Global
				styles={getTypographyStyles({
					className: `${WRAP_CLASSNAME} .bcb-form__label`,
			...
			<Global
				styles={getBorderStyles({
					className: `${CHECKBOX_RADIO_INPUT_CLASSNAME}, ${TOGGLE_CLASSNAME} .bcb-toggle__slider, ${TOGGLE_CLASSNAME} .bcb-toggle__slider::before`,
			...
			<Global
				styles={{
					...
					[`${TOGGLE_CLASSNAME}`]: {
						...
						"input:checked + .bcb-toggle__slider": {
							backgroundColor:
								style_checkbox_radio_toggle.colors.Active.backgroundColor,
						},
					},
