...
const GlobalCss: FC<Props> = (attrs) => {
	...
	const CONTENT_CLASSNAME = `${WRAP_CLASSNAME} .bcb-countdown__content`;
	const LABEL_CLASSNAME = `${WRAP_CLASSNAME} .bcb-countdown__label`;
	const NUMBER_CLASSNAME = `${WRAP_CLASSNAME} .bcb-countdown__number`;
	const BOX_CLASSNAME = `${WRAP_CLASSNAME} .bcb-countdown__box`;
	...
	return (
		<>
			...
			{ general_preset.preset != 'bcb-countdown-5' && (
				<Global
					styles={
						getStyleObjectFromResponsiveAttr({
							className: BOX_CLASSNAME,
