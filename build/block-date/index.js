...
const WcbDatePanelGenera = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.PanelBody, {
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Additional Validation", "boostify-blocks"),
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Helps to set range of calender", "boostify-blocks"),
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Min", "boostify-blocks"),
    value: min,
    type: "date",
    onChange: nextValue => {
      console.log(11, {
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Max", "boostify-blocks"),
    value: max,
    type: "date",
    onChange: nextValue => {
      setAttr__({
...
module.exports = /*#__PURE__*/JSON.parse('{"apiVersion":3,"name":"boostify-blocks/date","parent":["boostify-blocks/form"],"version":"0.1.0","title":"Date","category":"boostify-blocks","icon":"- wcb-block-editor-block-icon lni lni-calendar text-xl","description":"Example static block scaffolded with Create Block tool.","supports":{"__experimentalSelector":"span,label"},"textdomain":"boostify-blocks","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
