...
/***/ "./src/block-slider-swiper/FrontendStyles.tsx":
/*!****************************************************!*\
  !*** ./src/block-slider-swiper/FrontendStyles.tsx ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initCarouselForWcbSliderSwiper: () => (/* binding */ initCarouselForWcbSliderSwiper)
/* harmony export */ });
...
function equalizeItemHeights(wrap) {
  if (!wrap) return;
  const items = wrap.querySelectorAll(".wcb-slider-child__item-inner, .wcb-slider__item-inner");
...
function initCarouselForWcbSliderSwiper(div, props) {
  ...
  const ref = div.querySelector(".wcb-slider__wrap-items.swiper");
  ...
  try {
    const prevBtn = ref.querySelector(".swiper-button-prev");
    const nextBtn = ref.querySelector(".swiper-button-next");
    if (showArrowsDots !== "Dot") {
      if (prevBtn && !prevBtn.querySelector("svg")) {
        prevBtn.innerHTML = '<svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 19.5L8.25 12l7.5-7.5" /></svg>';
      }
      if (nextBtn && !nextBtn.querySelector("svg")) {
        nextBtn.innerHTML = '<svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" /></svg>';
      }
    }
    ...
    new window.Swiper(ref, {
      ...
      navigation: showArrowsDots !== "Dot" ? {
        prevEl: prevBtn,
        nextEl: nextBtn
      } : false,
      pagination: showArrowsDots !== "Arrow" ? {
...
/* harmony import */ var _block_slider_swiper_FrontendStyles__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../block-slider-swiper/FrontendStyles */ "./src/block-slider-swiper/FrontendStyles.tsx");
...
const classes = [{
  ...
  C: react__WEBPACK_IMPORTED_MODULE_0___default().lazy(() => Promise.all(/*! import() */[__webpack_require__.e("vendors-node_modules_emotion_react_dist_emotion-react_browser_esm_js"), __webpack_require__.e("src_block-slider-swiper_GlobalCss_tsx")]).then(__webpack_require__.bind(__webpack_require__, /*! ../block-slider-swiper/GlobalCss */ "./src/block-slider-swiper/GlobalCss.tsx"))),
  F: _block_slider_swiper_FrontendStyles__WEBPACK_IMPORTED_MODULE_4__.initCarouselForWcbSliderSwiper
}, {
