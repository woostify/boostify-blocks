...
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/settings.js");
...
const Edit = props => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    const DEFAULT = {
      ...
      style_layout: _WcbProductsPanel_StyleLayout__WEBPACK_IMPORTED_MODULE_18__.WCB_PRODUCTS_PANEL_STYLE_LAYOUT_DEMO,
      ...
      general_sortingAndFiltering: _WcbProducstPanelSortingAndFiltering__WEBPACK_IMPORTED_MODULE_11__.WCB_PRODUCTS_PANEL_SORTINGANDFILTERING_DEMO,
  ...
  const renderToobar = () => {
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_7__.Dropdown, {
      ...
      renderContent: () => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_7__.BaseControl, {
        ...
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Show pagination", "boostify-blocks"),
        ...
        id: "4",
        help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Limit the pages you want to show, even if the query has more results. To show all pages use 0 (zero).", "boostify-blocks")
...
const WcbProductsPanelPagination = ({
  ...
  const renderRadioIcons = () => {
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_controls_MyRadioGroup__WEBPACK_IMPORTED_MODULE_3__["default"], {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Prev & Next Icons", "boostify-blocks"),
      onChange: name => {
        setAttr__({
          ...panelData,
          iconName: name
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.PanelBody, {
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Show pagination", "boostify-blocks"),
    onChange: checked => setAttr__({
      ...panelData,
      isShowPagination: checked
    }),
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wcb/products","version":"0.1.0","title":"Products","category":"wcb-blocks","icon":"- wcb-block-editor-block-icon lni lni-restaurant","description":"Display products from your store in a grid layout.","supports":{"html":false,"align":["full","wide"]},"textdomain":"wcb-blocks","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
