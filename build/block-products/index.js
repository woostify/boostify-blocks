    ...
    return [{
      [POST_CARD_CLASS]: {
        ...
        ".wcb-products__product--quickViewBottomImage--item": {
          display: style_quickViewBtn?.position === "bottom-image" ? "none !important" : style_quickViewBtn?.position === "center-image" ? "none !important" : "unset",
          position: "absolute",
          top: "-10rem",
          right: "0rem"
        },
        ":hover": {
          ".wcb-products__product--quickViewBottomImage--item": {
            ...
            padding: style_quickViewBtn?.position === "bottom-image" ? "0.5rem !important" : style_quickViewBtn?.position === "center-image" ? "0.5rem 1.4rem !important" : "auto",
            // transition: "transform 0.2s ease-in-out",
            gap: "6px !important",
            position: "absolute",
            bottom: style_quickViewBtn?.position === "bottom-image" ? "10px !important" : style_quickViewBtn?.position === "center-image" && general_addToCartBtn?.position === "icon" ? "10rem" : style_quickViewBtn?.position === "center-image" && general_addToCartBtn?.position !== "icon" ? "6rem" : "auto",
            ...
            right: style_quickViewBtn?.position === "bottom-image" ? "0 !important" : style_quickViewBtn?.position === "center-image" ? "50%" : style_quickViewBtn?.position === "top-right" ? "-0.1rem" : "auto",
            width: style_quickViewBtn?.position === "bottom-image" ? "100%" : style_quickViewBtn?.position === "center-image" ? "auto" : style_quickViewBtn?.position === "top-right" ? "2.6rem" : "unset",
            ...
            borderRadius: style_quickViewBtn?.position === "top-right" ? `${style_quickViewBtn?.border_radius}px` : style_quickViewBtn?.position === "center-image" ? `27px` : "0px",
            zIndex: 10,
        ...
        "&.wcb-products__product--wishlistTopRight:hover": {
          ".wcb-products__product--wishlistTopRight--item": {
            ...
            top: general_addToCartBtn?.position === "icon" && style_wishlistBtn?.position === "top-right" && style_quickViewBtn?.position !== "top-right" ? "0" : style_quickViewBtn?.woostify_pro_active && general_addToCartBtn?.position === "icon" && style_wishlistBtn?.position === "top-right" && style_quickViewBtn?.position === "top-right" ? "2.48rem" : style_quickViewBtn?.woostify_pro_active == false && general_addToCartBtn?.position === "icon" && style_wishlistBtn?.position === "top-right" && style_quickViewBtn?.position === "top-right" ? "0" : style_quickViewBtn?.woostify_pro_active && general_addToCartBtn?.position !== "icon" && style_wishlistBtn?.position === "top-right" && style_quickViewBtn?.position === "top-right" ? "0" : "-2.5rem",
            right: 0,
            width: "2.5rem",
            height: "2.5rem",
            display: "flex",
...
function buildStyleQuickViewButtonDefault(attr) {
  var _ref37, _quickViewBtn$enabled, _ref38, _quickViewBtn$positio, _ref39, _quickViewBtn$show_ic, _ref40, _quickViewBtn$bg_colo, _ref41, _quickViewBtn$text_co, _ref42, _quickViewBtn$hover_b, _ref43, _quickViewBtn$hover_t, _ref44, _quickViewBtn$border_, _ref45, _quickViewBtn$woostif;
  const theme = (0,_utils_themeDefaults__WEBPACK_IMPORTED_MODULE_2__.getThemeDefaults)();
  ...
  return {
    ...
    ...(attr || {}),
    enabled: (_ref37 = (_quickViewBtn$enabled = quickViewBtn?.enabled) !== null && _quickViewBtn$enabled !== void 0 ? _quickViewBtn$enabled : attr?.enabled) !== null && _ref37 !== void 0 ? _ref37 : _WcbProductsPanel_StyleQuickViewButton__WEBPACK_IMPORTED_MODULE_14__.WCB_PRODUCTS_PANEL_STYLE_QUICKVIEW_BUTTON_DEMO.enabled,
    position: (_ref38 = (_quickViewBtn$positio = quickViewBtn?.position) !== null && _quickViewBtn$positio !== void 0 ? _quickViewBtn$positio : attr?.position) !== null && _ref38 !== void 0 ? _ref38 : _WcbProductsPanel_StyleQuickViewButton__WEBPACK_IMPORTED_MODULE_14__.WCB_PRODUCTS_PANEL_STYLE_QUICKVIEW_BUTTON_DEMO.position,
    show_icon: (_ref39 = (_quickViewBtn$show_ic = quickViewBtn?.show_icon) !== null && _quickViewBtn$show_ic !== void 0 ? _quickViewBtn$show_ic : attr?.show_icon) !== null && _ref39 !== void 0 ? _ref39 : _WcbProductsPanel_StyleQuickViewButton__WEBPACK_IMPORTED_MODULE_14__.WCB_PRODUCTS_PANEL_STYLE_QUICKVIEW_BUTTON_DEMO.show_icon,
    bg_color: (_ref40 = (_quickViewBtn$bg_colo = quickViewBtn?.bg_color) !== null && _quickViewBtn$bg_colo !== void 0 ? _quickViewBtn$bg_colo : attr?.bg_color) !== null && _ref40 !== void 0 ? _ref40 : _WcbProductsPanel_StyleQuickViewButton__WEBPACK_IMPORTED_MODULE_14__.WCB_PRODUCTS_PANEL_STYLE_QUICKVIEW_BUTTON_DEMO.bg_color,
    text_color: (_ref41 = (_quickViewBtn$text_co = quickViewBtn?.text_color) !== null && _quickViewBtn$text_co !== void 0 ? _quickViewBtn$text_co : attr?.text_color) !== null && _ref41 !== void 0 ? _ref41 : _WcbProductsPanel_StyleQuickViewButton__WEBPACK_IMPORTED_MODULE_14__.WCB_PRODUCTS_PANEL_STYLE_QUICKVIEW_BUTTON_DEMO.text_color,
    hover_bg_color: (_ref42 = (_quickViewBtn$hover_b = quickViewBtn?.hover_bg_color) !== null && _quickViewBtn$hover_b !== void 0 ? _quickViewBtn$hover_b : attr?.hover_bg_color) !== null && _ref42 !== void 0 ? _ref42 : _WcbProductsPanel_StyleQuickViewButton__WEBPACK_IMPORTED_MODULE_14__.WCB_PRODUCTS_PANEL_STYLE_QUICKVIEW_BUTTON_DEMO.hover_bg_color,
    hover_text_color: (_ref43 = (_quickViewBtn$hover_t = quickViewBtn?.hover_text_color) !== null && _quickViewBtn$hover_t !== void 0 ? _quickViewBtn$hover_t : attr?.hover_text_color) !== null && _ref43 !== void 0 ? _ref43 : _WcbProductsPanel_StyleQuickViewButton__WEBPACK_IMPORTED_MODULE_14__.WCB_PRODUCTS_PANEL_STYLE_QUICKVIEW_BUTTON_DEMO.hover_text_color,
    border_radius: (_ref44 = (_quickViewBtn$border_ = quickViewBtn?.border_radius) !== null && _quickViewBtn$border_ !== void 0 ? _quickViewBtn$border_ : attr?.border_radius) !== null && _ref44 !== void 0 ? _ref44 : _WcbProductsPanel_StyleQuickViewButton__WEBPACK_IMPORTED_MODULE_14__.WCB_PRODUCTS_PANEL_STYLE_QUICKVIEW_BUTTON_DEMO.border_radius,
    woostify_pro_active: (_ref45 = (_quickViewBtn$woostif = quickViewBtn?.woostify_pro_active) !== null && _quickViewBtn$woostif !== void 0 ? _quickViewBtn$woostif : attr?.woostify_pro_active) !== null && _ref45 !== void 0 ? _ref45 : _WcbProductsPanel_StyleQuickViewButton__WEBPACK_IMPORTED_MODULE_14__.WCB_PRODUCTS_PANEL_STYLE_QUICKVIEW_BUTTON_DEMO.woostify_pro_active
  };
}
