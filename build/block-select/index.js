...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"apiVersion":3,"name":"boostify-blocks/select","version":"0.1.0","title":"Select","parent":["boostify-blocks/form"],"category":"boostify-blocks","icon":"- wcb-block-editor-block-icon lni lni-select text-xl","description":"Example static block scaffolded with Create Block tool.","supports":{"__experimentalSelector":"span,label"},"textdomain":"boostify-blocks","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
