...
const MyContainerControl = ({
  ...
  if (!CONTENT_BOX_WIDTH) {
    CONTENT_BOX_WIDTH = ___WEBPACK_IMPORTED_MODULE_9__.DEMO_BOOSTIFYBLOCKS_GLOBAL_VARIABLES.defaultContentWidth || window.boostifyblocksLayoutGlobalSettings.contentSize;
  }
  const {
