...
const GlobalCss = attrs => {
  ...
  const getInner__contentCustomWidth = () => {
    ...
    if (!contentBoxWidth.Desktop && !contentBoxWidth.Tablet && !contentBoxWidth.Mobile) {
      contentBoxWidth = {
        Desktop: ___WEBPACK_IMPORTED_MODULE_7__.DEMO_BOOSTIFYBLOCKS_GLOBAL_VARIABLES.defaultContentWidth || ""
      };
    }
    const {
...
const MyContainerControl = ({
  ...
  if (!CONTENT_BOX_WIDTH) {
    CONTENT_BOX_WIDTH = ___WEBPACK_IMPORTED_MODULE_9__.DEMO_BOOSTIFYBLOCKS_GLOBAL_VARIABLES.defaultContentWidth || window.boostify_blocks_layout_global_settings.contentSize;
  }
  const {
  ...
  const renderContentBoxWidth = () => {
    ...
    }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_controls_HelpText__WEBPACK_IMPORTED_MODULE_11__["default"], null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Default content box width " + ___WEBPACK_IMPORTED_MODULE_9__.DEMO_BOOSTIFYBLOCKS_GLOBAL_VARIABLES.defaultContentWidth)));
  };
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"apiVersion":3,"name":"boostify-blocks/container","version":"0.1.0","title":"Container","category":"boostify-blocks","icon":"- wcb-block-editor-block-icon lni lni-layout","description":"Create beautiful layouts with flexbox powered container block.","supports":{"html":false,"anchor":true,"align":["wide","full"]},"textdomain":"boostify-blocks","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
