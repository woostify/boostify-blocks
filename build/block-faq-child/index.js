...
const Edit = props => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    const faqDefaultExtend = isGrid ? true : !faqCollapseOtherItems || faqCollapseOtherItems && !blockIndex && faqExpandFirstItem;
    setAttributes({
  ...
  const renderIcon = () => {
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, isActive && general_icon.icon && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_controls_MyIconFull__WEBPACK_IMPORTED_MODULE_7__["default"], {
      className: "wcb-faq-child__icon wcb-faq-child__icon--active",
      icon: general_icon.icon
    }), !isActive && general_icon.inactiveIcon && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_controls_MyIconFull__WEBPACK_IMPORTED_MODULE_7__["default"], {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_MyCacheProvider__WEBPACK_IMPORTED_MODULE_6__["default"], {
    ...
    ...wrapBlockProps,
    className: `${wrapBlockProps?.className} wcb-faq-child__wrap wcb-faq-child__wrap--${layout} ${isActive ? "active" : ""} ${uniqueId}`,
  ...
  }), general_icon.iconPosition === "right" && renderIcon())), (isActive || layout === "grid") && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "ac-panel"
