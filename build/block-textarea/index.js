...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./editor.scss */ "./src/block-textarea/editor.scss");
...
/* harmony import */ var _WcbTextareaPanelGeneral__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./WcbTextareaPanelGeneral */ "./src/block-textarea/WcbTextareaPanelGeneral.tsx");
...
const Edit = props => {
  ...
  const UNIQUE_NAME = (0,_utils_converUniqueId__WEBPACK_IMPORTED_MODULE_7__["default"])(uniqueId, "textarea");
  // make uniqueid
  ...
  const renderTabBodyPanels = tab => {
    switch (tab.name) {
      case "General":
        return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_WcbTextareaPanelGeneral__WEBPACK_IMPORTED_MODULE_5__["default"], {
...
function save({
  ...
  const UNIQUE_NAME = (0,_utils_converUniqueId__WEBPACK_IMPORTED_MODULE_4__["default"])(uniqueId, "textarea");
  //
...
const WcbTextareaPanelGeneral = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.PanelBody, {
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Address", "boostify-blocks"))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.__experimentalInputControl, {
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Number of lines", "boostify-blocks"),
    value: rows,
    onChange: value => {
      setAttr__({
        ...panelData,
...
module.exports = /*#__PURE__*/JSON.parse('{"apiVersion":3,"name":"boostify-blocks/textarea","version":"0.1.0","parent":["boostify-blocks/form"],"title":"Textarea","category":"boostify-blocks","icon":"- wcb-block-editor-block-icon lni lni-pencil-alt text-xl","description":"Example static block scaffolded with Create Block tool.","supports":{"__experimentalSelector":"span,label"},"textdomain":"boostify-blocks","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
