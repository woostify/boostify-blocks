<?php
/**
 * Frontend CSS for FAQ Child Block.
 *
 * Most FAQ child styles are controlled by the parent block (block-faq).
 * This file handles child-specific advance attributes (responsive conditions, z-index).
 *
